  ...
  return (
    <div className="fixed top-0 left-0 w-full shadow-md bg-white z-50">
      <div className="wrapper flex items-center justify-between h-[93px]">
          ...
          {HeaderMenu.map((item) => (
            <li key={item.id}>
              <NavLink
                to={item.link}
                className={({ isActive }) =>
                  `text-[10px] md:text-[12px] lg:text-[14px] hover:text-[var(--secondary-color)] font-[400] ${isActive
        ...
        <button className="bg-[#0F334C] h-full px-10 hover:bg-[#F26122] text-white hidden md:block cursor-pointer" onClick={() => navigate("/login")}>
          Login
        </button>
      ...
      {isMenuOpen && (
        <>
          ...
          <div className="md:hidden bg-white w-full absolute top-[93px] left-0 shadow-md z-50">
              ...
              {HeaderMenu.map((item) => (
                <li key={item.id}>
                  <NavLink
                    ...
                    to={item.link}
                    className={({ isActive }) =>
                      `text-[15px] hover:text-[--secondary-color] font-[400] ${isActive ? "text-(--secondary-color)" : ""
                      }`
                    }
                  >
                    {item.title}
            ...
            <button className="bg-[#0F334C] text-white w-[90%] mx-auto block mb-4 py-2 hover:bg-[#F26122]" onClick={() => navigate("/login")}>
              Login
            </button>
